...
<div className="">
      <div className="bg-blue h-[150px] flex justify-center items-center">
        ...
        <div className="bg-green  h-[60px] w-[98%] rounded-[5px] flex justify-start items-center">
...
<h1 className='text-white font-[400] text-[20px] p-[10px]'>All Systems Operational</h1>
</div>
        </div>
        </div>
        <div className="mt-[30px] ml-[28px] mb-[15px]">
            <h2 className='text-black font-[400] text-[30px]'>
                Current Status
            </h2>
        </div>
